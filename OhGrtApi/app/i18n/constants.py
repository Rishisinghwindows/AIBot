...
ZODIAC_SIGNS: Dict[str, Dict[str, str]] = {
    "aries": {
        "en": "Aries", "hi": "मेष", "bn": "মেষ", "te": "మేషం",
        "mr": "मेष", "ta": "மேஷம்", "gu": "મેષ", "kn": "ಮೇಷ",
        "ml": "മേടം", "pa": "ਮੇਖ", "or": "ମେଷ", "sa": "मेषः",
    },
    "taurus": {
        "en": "Taurus", "hi": "वृषभ", "bn": "বৃষ", "te": "వృషభం",
        "mr": "वृषभ", "ta": "ரிஷபம்", "gu": "વૃષભ", "kn": "ವೃಷಭ",
        "ml": "ഇടവം", "pa": "ਬ੍ਰਿਸ਼", "or": "ବୃଷ", "sa": "वृषभः",
    },
    "gemini": {
        "en": "Gemini", "hi": "मिथुन", "bn": "মিথুন", "te": "మిథునం",
        "mr": "मिथुन", "ta": "மிதுனம்", "gu": "મિથુન", "kn": "ಮಿಥುನ",
        "ml": "മിഥുനം", "pa": "ਮਿਥੁਨ", "or": "ମିଥୁନ", "sa": "मिथुनम्",
    },
    "cancer": {
        "en": "Cancer", "hi": "कर्क", "bn": "কর্কট", "te": "కర్కాటకం",
        "mr": "कर्क", "ta": "கடகம்", "gu": "કર્ક", "kn": "ಕರ್ಕಾಟಕ",
        "ml": "കർക്കടകം", "pa": "ਕਰਕ", "or": "କର୍କଟ", "sa": "कर्कटः",
    },
    "leo": {
        "en": "Leo", "hi": "सिंह", "bn": "সিংহ", "te": "సింహం",
        "mr": "सिंह", "ta": "சிம்மம்", "gu": "સિંહ", "kn": "ಸಿಂಹ",
        "ml": "ചിങ്ങം", "pa": "ਸਿੰਘ", "or": "ସିଂହ", "sa": "सिंहः",
    },
    "virgo": {
        "en": "Virgo", "hi": "कन्या", "bn": "কন্যা", "te": "కన్య",
        "mr": "कन्या", "ta": "கன்னி", "gu": "કન્યા", "kn": "ಕನ್ಯಾ",
        "ml": "കന്നി", "pa": "ਕੰਨਿਆ", "or": "କନ୍ୟା", "sa": "कन्या",
    },
    "libra": {
        "en": "Libra", "hi": "तुला", "bn": "তুলা", "te": "తుల",
        "mr": "तूळ", "ta": "துலாம்", "gu": "તુલા", "kn": "ತುಲಾ",
        "ml": "തുലാം", "pa": "ਤੁਲਾ", "or": "ତୁଳା", "sa": "तुला",
    },
    "scorpio": {
        "en": "Scorpio", "hi": "वृश्चिक", "bn": "বৃশ্চিক", "te": "వృశ్చికం",
        "mr": "वृश्चिक", "ta": "விருச்சிகம்", "gu": "વૃશ્ચિક", "kn": "ವೃಶ್ಚಿಕ",
        "ml": "വൃശ്ചികം", "pa": "ਬ੍ਰਿਸ਼ਚਕ", "or": "ବୃଶ୍ଚିକ", "sa": "वृश्चिकः",
    },
    "sagittarius": {
        "en": "Sagittarius", "hi": "धनु", "bn": "ধনু", "te": "ధనుస్సు",
        "mr": "धनु", "ta": "தனுசு", "gu": "ધન", "kn": "ಧನು",
        "ml": "ധനു", "pa": "ਧਨੁ", "or": "ଧନୁ", "sa": "धनुः",
    },
    "capricorn": {
        "en": "Capricorn", "hi": "मकर", "bn": "মকর", "te": "మకరం",
        "mr": "मकर", "ta": "மகரம்", "gu": "મકર", "kn": "ಮಕರ",
        "ml": "മകരം", "pa": "ਮਕਰ", "or": "ମକର", "sa": "मकरः",
    },
    "aquarius": {
        "en": "Aquarius", "hi": "कुम्भ", "bn": "কুম্ভ", "te": "కుంభం",
        "mr": "कुंभ", "ta": "கும்பம்", "gu": "કુંભ", "kn": "ಕುಂಭ",
        "ml": "കുംഭം", "pa": "ਕੁੰਭ", "or": "କୁମ୍ଭ", "sa": "कुम्भः",
    },
    "pisces": {
        "en": "Pisces", "hi": "मीन", "bn": "মীন", "te": "మీనం",
        "mr": "मीन", "ta": "மீனம்", "gu": "મીન", "kn": "ಮೀನ",
        "ml": "മീനം", "pa": "ਮੀਨ", "or": "ମୀନ", "sa": "मीनः",
    },
}
