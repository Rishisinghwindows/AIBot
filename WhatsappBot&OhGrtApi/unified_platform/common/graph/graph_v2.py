...
To use this new architecture:
    from common.graph_v2 import process_message_v2
"""
...
from common.conversation_manager import enrich_with_context, get_conversation_manager

# Astrology sub-graph
from common.graphs.astro_graph import get_astro_graph
...
To switch to V2 in main.py:
    ...
    # New
    from common.graph_v2 import process_message_v2 as process_message
"""
