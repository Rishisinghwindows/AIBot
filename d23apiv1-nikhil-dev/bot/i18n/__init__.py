...
Usage:
    from bot.i18n import get_translator, detect_language
...
from bot.i18n.detector import detect_language, get_language_name
from bot.i18n.translator import Translator, get_translator
from bot.i18n.constants import (
    SUPPORTED_LANGUAGES,
    LANGUAGE_NAMES,
    ZODIAC_SIGNS,
    NAKSHATRA_NAMES,
