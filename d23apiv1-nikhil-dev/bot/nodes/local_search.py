...
from bot.tools.serper_search import search_places
...
async def handle_local_search(state: BotState) -> dict:
    ...
    if not location and query_to_check:
        ...
        if extracted_location:
            search_query = search_query or extracted_query
    ...
    try:
        ...
        if result["success"]:
            ...
            if places:
                ...
                response_lines.append("*Found these places:*\n")
    ...
    try:
        ...
        if result["success"]:
            ...
            if places:
                ...
                response_lines.append("*Found these places near you:*\n")
